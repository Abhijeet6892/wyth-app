...
import { supabase } from '@/utils/supabase/client' // REAL DB CONNECTION
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs text-slate-500 mt-1">
                ...
                {/* Debug: Show City to verify sort */}
...
export default function Home() {
  ...
  const fetchFeed = async (userProfile?: any) => {
      ...
      if (postsData) {
          if (userProfile) {
              ...
              setPosts(postsData) // No profile? Show chrono
          }
      }
      setLoading(false)
  }
  ...
  useEffect(() => {
    const initData = async () => {
        ...
        await fetchFeed(profile) // Pass profile to sorting algo
    }
