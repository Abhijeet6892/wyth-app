...
export default function NotificationsPage() {
  ...
  const getIcon = (type: string) => {
    switch(type) {
      ...
      case 'connection_accepted': return <UserPlus size={18} style={{ color: '#10b981' }} />
      ...
      case 'like':                return <Heart size={18} style={{ color: '#f43f5e' }} />
  ...
  const getBgColor = (type: string) => {
    switch(type) {
      ...
      case 'connection_accepted': return { bg: 'rgba(16, 185, 129, 0.05)',  border: 'rgba(16, 185, 129, 0.1)' }
      ...
      case 'like':                return { bg: 'rgba(244, 63, 94, 0.05)',   border: 'rgba(244, 63, 94, 0.1)' }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        WebkitBackdropFilter: 'blur(20px)', padding: '16px 16px',
        ...
        <Link
          ...
          style={{
            ...
            color: '#64748b', transition: 'background 0.2s', textDecoration: 'none',
        ...
        <h1 style={{
          ...
          {notifications.some(n => !n.is_read) && (
            <div style={{
              ...
              borderRadius: '50%', boxShadow: '0 0 8px rgba(239, 68, 68, 0.5)',
      ...
      <div style={{
        ...
        maxWidth: '640px', margin: '0 auto', position: 'relative', zIndex: 10
      }}>
        {loading ? (
          <div style={{
            display: 'flex', flexDirection: 'column', alignItems: 'center',
            justifyContent: 'center', paddingTop: '80px', paddingBottom: '80px', gap: '16px'
          }}>
          ...
          <div style={{
            display: 'flex', flexDirection: 'column', alignItems: 'center',
            paddingTop: '80px', paddingBottom: '80px', color: '#94a3b8'
          }}>
            <div style={{
              width: '64px', height: '64px', background: 'rgba(241, 245, 249, 0.6)',
              ...
              return (
                <motion.div 
                  ...
                  style={{
                    ...
                    padding: '16px', display: 'flex', alignItems: 'flex-start',
                    gap: '16px', transition: 'all 0.2s',
                    background: n.is_read ? 'rgba(255, 255, 255, 0.75)' : 'rgba(255, 255, 255, 0.9)',
                ...
                >
                  {!n.is_read && (
                    <div style={{
                      ...
                      borderRadius: '50%', boxShadow: '0 0 8px rgba(99, 102, 241, 0.5)'
                    }} />
                  )}
                  ...
                  <div style={{
                    ...
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    flexShrink: 0, border: `1px solid ${colors.border}`, background: colors.bg
                  }}>
                    {getIcon(n.type)}
                  </div>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <p style={{ fontSize: '14px', color: '#475569', lineHeight: '1.5', marginBottom: '8px' }}>
                      {n.content}
                    </p>
                  ...
                  <div style={{
                    width: '40px', height: '40px', borderRadius: '50%',
                    background: 'rgba(226, 232, 240, 0.5)', overflow: 'hidden',
